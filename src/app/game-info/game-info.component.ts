...
export class GameInfoComponent implements OnInit, OnChanges {
  // Array of actions assigned to a card value (ace + numbers 2-10 + jack + queen + king )
  cardAction = [
    {
      title: 'Waterfall',
    ...
    { title: 'Thumbmaster', description: 'When you put your thumb on the table everyone must follow. Whomever is last must drink. You are the thumb master till someone else picks a five.' },
    { title: 'Men', description: 'All men drink.' },
    { title: 'Quizmaster', description: 'Ask a question. Everyone who is wrong has to drink' },
    {
